...
const WHATSAPP_SUPORTE = 'https://wa.me/5511999999999?text=Ol%C3%A1%2C%20preciso%20de%20ajuda%20com%20meu%20pagamento%20no%20CRASH%20Cifras'

export function AssinaturaErro() {
  return (
    <section className="flex min-h-[60vh] flex-col items-center justify-center space-y-6 text-center">
      <div className="max-w-md space-y-5">
        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:justify-center">
          <Link to="/assinatura" className={`inline-block ${btnPrimaryClassName}`}>
            Tentar novamente
          </Link>
          <a
            ...
            className={`inline-flex items-center gap-2 ${btnSecondaryClassName}`}
          >
