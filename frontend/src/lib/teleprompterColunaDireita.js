...
/** Card “Medley / Próxima música” — acima da fila 📝 + YouTube para não sobrepor. */
export const TELEPROMPTER_MEDLEY_BOTTOM_MOBILE =
  TELEPROMPTER_ANOTACAO_BOTTOM_MOBILE + TELEPROMPTER_YOUTUBE_PILL_SIZE + 8
export const TELEPROMPTER_MEDLEY_BOTTOM_DESKTOP =
  TELEPROMPTER_ANOTACAO_BOTTOM + TELEPROMPTER_ANOTACAO_ICON_ALTURA + 8
/** Margem direita reservada para 📝 (e bolinha YouTube no mobile). */
export const TELEPROMPTER_MEDLEY_RESERVE_RIGHT_MOBILE =
  ...
  8
export const TELEPROMPTER_MEDLEY_RESERVE_RIGHT_DESKTOP =
  TELEPROMPTER_ANOTACAO_RIGHT + TELEPROMPTER_ANOTACAO_ICON_ALTURA + 12
